...
class STGCNGraphConv(nn.Module):
    ...
    def __init__(self, args, blocks, n_vertex):
        ...
        for l in range(len(blocks) - 3):
            modules.append(layers.STConvBlock(args.Kt, args.Ks, n_vertex, blocks[l][-1], blocks[l+1], args.act_func, args.gso, args.enable_bias, args.droprate))
